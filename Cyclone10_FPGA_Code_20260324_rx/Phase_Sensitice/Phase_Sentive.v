module Phase_Sensitive(
	...
	input					dclk,
	/*******正弦ROM表************/
	input [15:0]			cos_rom_data,	
	input [15:0]			sin_rom_data,
	/***AD4020数据接口***********/
	input signed [19:0] 	ADdata, 		        //AD采集结果
	/***检波后的IQ***************/
...
wire [63:0] SIN_I_fir;	
wire [63:0] COS_Q_fir;
wire [35:0] result_sin;			
wire [35:0] result_cos;			 
...
always@(posedge dclk) begin
	if(Phase_Sensitive_Done && dclk_sin100) begin
		...
		//	SIN_I <= SIN_I;
		//	COS_Q <= COS_Q;
			SIN_I <= 32'bzzzz_zzzz_zzzz_zzzzzzzz_zzzz_zzzz_zzzz;//检波后输出的值0.5Acos相位
			COS_Q <= 32'bzzzz_zzzz_zzzz_zzzzzzzz_zzzz_zzzz_zzzz;//检波后输出的值0.5Asin相位
	end
end
